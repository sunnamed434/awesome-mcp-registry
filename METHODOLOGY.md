...
|-----------|--------|------------------|-------------------|
| AI assessment | **35%** | Substance of the project: documentation quality, real-world utility, maturity | DeepSeek-V4.1-Flash rates three anchored dimensions 0–4 each (anchors below); score = (doc + utility + maturity) / 12 × 100 |
...
`prompt_version` bumps force a clean re-evaluation after deliberate prompt or judge-model changes.
