...
def main():
    ...
    print("\n[3/6] Fetching from MCP Registry...")
    ...
    print(f"\n[5/6] Analyzing (max {MAX_NEW_ANALYSES} new repos)...")
    analyzed = 0
    ...
    print(f"\nDone! Analyzed {analyzed} new repos. "
